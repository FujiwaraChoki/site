...
function CircleArrowRight({ title = 'badge 13', ...props }: IconProps) {
  return (
    <svg height="24" id="circle-arrow-right" width="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" {...props}>
      <title>{title}</title>
      <g fill="none">
